...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default="/export/livia/home/vision/projects/Point-MAMBA-New/PointMamba/part_segmentation/cfgs/config.yaml", help='config file')
    # parser.add_argument('--step_size', type=int, default=20, help='decay step for lr decay')
    # parser.add_argument('--lr_decay', type=float, default=0.5, help='decay rate for lr decay')  
    parser.add_argument('--ckpts', type=str, default=None, help='ckpts') 
    parser.add_argument('--root', type=str, default='/export/livia/home/vision/projects/Point-MAE/Point-MAE-org/Point-MAE/data/shapenetcore_partanno_segmentation_benchmark_v0_normal/',
                        help='data root')
...
def main(args):
    ...
    train_transforms_rotate = transforms.Compose(  
    [
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, (points, label, target) in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            ########### Added by XXXX-2
            if (config.rotation_aug == True): 
                points = train_transforms_rotate(points.transpose(2, 1)).transpose(2, 1) 
            elif (config.sccale_tranlate == True):
                points = test_transforms(points.transpose(2, 1)).transpose(2, 1) 
            ########################
